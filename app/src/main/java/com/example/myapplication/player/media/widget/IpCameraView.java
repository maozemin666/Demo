package com.example.myapplication.player.media.widget;
...
//import com.huawei.hwmcof.presentation.view.videodemo.player.model.AuthInfo;
//import com.huawei.hwmcof.presentation.view.videodemo.player.model.Profile;
//import com.huawei.hwmcof.presentation.view.videodemo.player.utils.IpcUtils;
//import com.huawei.hwmcof.presentation.view.videodemo.player.utils.XmlParserUtils;

import com.example.myapplication.player.model.AuthInfo;
import com.example.myapplication.player.model.Profile;
import com.example.myapplication.player.utils.IpcUtils;
import com.example.myapplication.player.utils.XmlParserUtils;
...
public class IpCameraView extends FrameLayout {
    ...
    private String pwString = "123456";
    ...
    private Runnable mPlayRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (mAuthInfo != null) {
                mRtspUrl = "rtsp://" + mName + ":" + pwString + "@" + mRtspUrl.substring(7);
            }
    ...
    public void startPlay(String rtspUrl){
        mIjkVideoView.setVideoPath(rtspUrl);
        mIjkVideoView.start();
    }
    ...
    private List<Profile> getProfiles(String mediaUrl) {
        ...
        if ("401".equals(response)) {
            Log.e(TAG, "需要鉴权");
            //未鉴权
            pwString = password.get(mServiceUrl);
            mAuthInfo = IpcUtils.createAuthInfo(mName, pwString);
